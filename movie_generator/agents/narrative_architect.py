...
class NarrativeArchitect:
    ...
    def write_screenplay(self, repo_analysis: dict, mock_mode: bool = False) -> dict:
        ...
        If mock_mode is True or GEMINI_API_KEY is missing, returns the premium 'Gardener of Echoes' screenplay.
        """
        ...
        try:
            ...
            response = self.client.models.generate_content(
                model='gemini-2.5-pro', # Use Pro for richer, more creative writing
                contents=prompt,
            ...
            print(f"Error in NarrativeArchitect: {e}. Falling back to mock screenplay.")
            return self.write_screenplay(repo_analysis, mock_mode=True)
